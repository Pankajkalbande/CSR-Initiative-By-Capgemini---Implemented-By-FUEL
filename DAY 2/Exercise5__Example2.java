...
Run the program with several values for X (edit the program for each value of X) and examine the result.
 ...
 The quadradic should evaluate to zero at X = 2.0 and at X = 2/3. Try these values for X. 
 Are the results exactly correct?   */



public class Exercise5__Example2{
    public static void main(String[] args) {
        
        // double varible  = 3x^2 - 8x + 4;
